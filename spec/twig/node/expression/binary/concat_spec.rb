describe Twig::Node::Expression::Binary::Concat do

  it 'Constructor' do
    left = Twig::Node::Expression::Constant.new(1, 1)
    right = Twig::Node::Expression::Constant.new(2, 1)
    node = Twig::Node::Expression::Binary::Concat.new(left, right, 1)
  ...
  it ' ' do
    ...
    expect(compiler.compile(node).get_source).to eq('(1.to_s + 2.to_s)')
  end
end
